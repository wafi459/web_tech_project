...
<body>
 ...
 <br><br><br>
    ...
    <button type="submit" class="fixd"> Property</button>
    <br><br>
    <a href="../views/Favourite.php">
    <button type="submit"> Favorites</button></a>
 <br><br>
 ...
 <div class="all-property">
  ...
  <table>
      <tr>
        ...
        <td><a href="updatePass.php" ><button type="submit"><img src="resetpass.png" alt="" width="45" height="45">Update Password</button></a></td>
   ...
   <td><a href="../controllers/logout.php">
     <button type="submit"><img src="logoutImg.png" alt="" width="45" height="45">Log out</button></a> </td>
      </tr>
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
       echo "<br>"."<fieldset >"."<table>"."<tr>"."<td >"."<b>"."Property Name: "."</b>" . $row["property_name"]."</td>". "<td>"."<b>"."  Price: " ."</b>".$row["price"]."</td>"."<td>";
       echo '<button class="buy">Buy</button></td>';
       echo '<td><button class="save"><a href="../controllers/Favourite.php">Save</a></button></td>';
       echo "</tr>";
       echo  "<tr>". "<td>"."<b>". "  Location: " ."</b>". $row["location"]. "</td>"."<td>". "<b>"."  Property Details: " ."</b>". $row["details"]. "</td>";
       echo '<td><button class="contact">Contact</button></td>';
