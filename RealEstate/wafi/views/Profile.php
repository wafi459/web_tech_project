...
$sql = "SELECT username,Email, password FROM ADMIN WHERE username ='$username' ";
   ...
   <div class="all-property">
    ...
    <table>
        <tr>
            ...
            <tr> <th>Last Name</th><td><?php echo  $username ?></td> </tr>
            <tr> <th>Email</th><td><?php echo $email ?></td> </tr>
            <tr> <th>Password</th><td><?php echo  $Pass ?></td> 
            <td><a href="updatePass.php" ><button class="delete">Change Password</button></a></td>
        </tr>
