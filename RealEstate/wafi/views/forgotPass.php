...
<head>
 ...
 <script  src="js_SignupValidation.js"></script>
</head>
<body>
                                        ...
                                        <tr>
                                             ...
                                             <tr>
                                              ...
                                              <td><p > <br> <label for="pass">Password:</p></td></label>
                                                ...
                                                <tr> <td colspan="1"><a href="login.php" >Go to Login</a></td>  
                                          <td>    </td>  <td colspan="1"><input type="submit" value="Reset" id="bt3"></td></tr>
